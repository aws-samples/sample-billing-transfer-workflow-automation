...
Run `pnpm exec nx build @billing-partner-portal/infra [--skip-nx-cache]` to build the application.

## Running unit tests

Run `pnpm exec nx test @billing-partner-portal/infra` to execute the unit tests via Vitest.

### Updating snapshots

To update snapshots, run the following command:

`pnpm exec nx test @billing-partner-portal/infra --configuration=update-snapshot`

## Run lint

Run `pnpm exec nx lint @billing-partner-portal/infra`

### Fixable issues

You can also automatically fix some lint errors by running the following command:

`pnpm exec nx lint @billing-partner-portal/infra --configuration=fix`

## Deploy to AWS

### Deploy all Stacks

Run `pnpm exec nx deploy @billing-partner-portal/infra --all`

### Deploy a single Stack

Run `pnpm exec nx deploy @billing-partner-portal/infra [stackName]`
...
Run `pnpm exec nx deploy @billing-partner-portal/infra --hotswap --all`
...
```typescript
import { suppressRules } from ':billing-partner-portal/common-constructs';
